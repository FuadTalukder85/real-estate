        ...
        <div className="py-32 font-semibold">
          ...
          <ul className="text-white text-lg mt-10">
            <li className="flex gap-3 items-center">
              <span className="border-2 border-[#ffac37] p-1 text-sm rounded-full">
                <FaLocationDot />
              </span>{" "}
          ...
          <div className="mt-14 mb-10">
            ...
            <ul className="flex gap-2 p-5 bg-[#2A4766]">
              ...
              <button className="flex items-center gap-3 p-3 px-6 bg-[#ffac37] text-white text-sm uppercase hover:bg-[#ffb958] hover:text-white transition-all duration-700">
                {" "}
                Search
              </button>
            </ul>
