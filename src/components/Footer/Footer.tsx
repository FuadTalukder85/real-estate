        ...
        <div className="grid grid-cols-12 gap-16 text-white py-24">
          ...
          <div className="col-span-3">
            ...
            <ul className="mt-8">
              ...
              <li className="mt-3 hover:text-[#ffac37] transition-all duration-700">
                All Listing
              </li>
              <li className="mt-3 hover:text-[#ffac37] transition-all duration-700">
                All location
          ...
          <div className="col-span-3">
            ...
            <ul className="mt-8">
              <li className="flex gap-3 items-center hover:text-[#ffac37] transition-all duration-700">
                <FiPhoneCall className="text-[#ffac37] text-lg" /> 01756-867585
              </li>
              <li className="flex gap-3 items-center mt-4 hover:text-[#ffac37] transition-all duration-700">
                <MdOutlineAttachEmail className="text-[#ffac37] text-lg" />{" "}
                webfuadtk@gmail.com
              </li>
              <li className="flex gap-3 items-center mt-4 hover:text-[#ffac37] transition-all duration-700">
                <CiGlobe className="text-[#ffac37] text-lg" />{" "}
                <Link href="https://fuad-talukder.vercel.app/">
                  fuad-talukder.vercel.app
                </Link>
              </li>
              <li className="flex gap-3 items-center mt-4 hover:text-[#ffac37] transition-all duration-700">
                <IoLocationOutline className="text-[#ffac37] text-lg" /> Uttor
