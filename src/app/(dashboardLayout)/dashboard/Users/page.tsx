    ...
    <div className="px-10 p-5 text-[#2A4766]">
      <div className="mt-10">
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="flex justify-between items-center p-2 border-s border-r border-b bg-white px-5">
              <td className="">1</td>
              <td className="w-1/6 flex items-center space-x-3">
                <Image
                  ...
                  width={40}
                ></Image>
                <span className=" font-medium">Fuad Talukder</span>
              </td>
              <td className="w-1/6">snjack1920@gmail.com</td>
              <td className="w-1/6">30 August 2024 01:48</td>
