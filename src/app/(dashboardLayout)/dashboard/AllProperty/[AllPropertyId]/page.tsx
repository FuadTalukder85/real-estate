    ...
    <div className="p-10">
      ...
      <div className="grid grid-cols-12 gap-5 mt-5">
        ...
        <div className="col-span-9">
          ...
          <p className="flex items-center justify-between text-seaBlue font-semibold text-xl mt-5">
            <span>$80,675.00</span>
            <span className="flex items-center gap-2">
              <SlCalender /> {singleProperty?.date}
            </span>
          </p>
          <ul className="flex justify-between bg-white text-seaBlue font-semibold p-3 px-8 mt-5 rounded-md">
            ...
            <li className="flex gap-8 items-center">
              <p className="flex gap-2 items-center">
                <RxSize className="text-yellow" /> <span>2</span>
                <span>sqft</span>
              </p>
              <span className="border-r h-3"></span>
            </li>
            ...
            <li className="">
              <p className="flex gap-2 items-center">
                <GiCheckMark className="text-yellow" /> <span>2</span>
                <span>For Sale</span>
              </p>
            </li>
          </ul>
          <p className="text-seaBlue font-semibold mt-5">Property Details :</p>
          <p className="text-seaBlue pr-36">{singleProperty?.description}</p>
        </div>
      </div>
    </div>
  );
